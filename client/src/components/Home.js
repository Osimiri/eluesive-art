...
function Home() {
    ...
    return (
        ...
        <div class= "snap-y snap-mandatory h-screen w-screen overflow-scroll">
          <div class="min-h-screen bg-[#f5f1ed] w-screen pt-20 flex flex-col justify-center snap-start">
          ...
          <div class="min-h-screen bg-[#a1a485] w-screen pt-20 flex flex-col justify-center snap-start">
          ...
          <div class="min-h-screen bg-[#4a5240] w-screen pt-20 flex flex-col justify-center snap-start">
