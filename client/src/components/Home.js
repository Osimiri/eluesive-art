...
function Home() {
  // Code goes here!
    ...
    return (
        ...
        <div class="min-h-screen bg-[#f5f1ed] w-screen pt-20 flex flex-col justify-evenly">
          {/* <h1>Eluesive Art</h1>
          <h1>Eluesive Art</h1>
          <h1>Eluesive Art</h1> */}
          <h1 class="text-6xl font-bold underline mt-20 ml-96">What is it?</h1>
          <div class = "container mr-96 flex flex-row bg-white ">

            <div class="bg-pink">
              <p class="text-left text-2xl ">Eluesive Art is a platform designed to help artists stay productive, motivated, and engaged with their creative process. Whether you're looking for feedback, support, or inspiration, our community is here to help you achieve your artistic goals.</p>
              
              <p class="text-left text-2xl" >Welcome to our creative community! We are a website designed for artists who want to stay motivated and productive.
              ...
              <p class="text-left text-2xl">Our platform provides you with the tools you need to track your progress, share updates on your projects, and receive support from like-minded individuals.
                  We encourage you to use this space as a place of inspiration, collaboration, and celebration of your artistic endeavors.</p>
              <p class="text-left text-2xl">So, whether you're a painter, sculptor, musician, writer, or any other type of artist, we invite you to join our community and start sharing your work today.
        ...
        <div class="min-h-screen bg-[#9d9583] w-screen pt-20">
          <h1 class="text-6xl font-bold underline mt-20 ml-96 ">How Does It Work?</h1>
          <div class="container  list-decimal  ">
